...
TestRegistry :: proc(registry: ^ItemDefinitionRegistry, strReg: ^ItemCstringRegistry, debug: bool){
    ...
    false,
    1600,
    { {.Pirece, 2}, {.Accurate, 1}, {.Cumbersome, 2}, {.Stun_Setting, 0} },
    ...
    true,
    6000,
    { {.Pirece, 2}, {.Full_Auto, 0}, {.Cumbersome, 5}, {.Vicious, 1} },
    {  },
    ItemCategory.Weapon,
    { .Blaster, .Ranged },
    18000,
    ...
    true,
    7500,
    { {.Breach, 1}, {.Blast, 10}, {.Cumbersome, 3}, {.Guided, 3}, {.Limited_Ammo, 6}, {.Prepare, 1} },
    {  },
    ItemCategory.Weapon,
    { .Ranged },
    15000,
